...
namespace RandomTF2Loadout.Steam_Interface
{
	...
	public class WeaponTypeRootObject
	{
	...
	class WeaponGather
	{
		public static Item[] getWeapons()
		{
			...
			WeaponTypeRootObject wtro = JsonConvert.DeserializeObject<WeaponTypeRootObject>(General.htmlDownloader.downloadHTML("http://api.steampowered.com/IEconItems_440/GetSchema/v0001/?key={0}", SteamKEY.key));
